...
--
-- Hôte : localhost:3306
-- Généré le : mer. 22 sep. 2021 à 02:11
...
INSERT INTO `Article` (`ID`, `Titre`, `Contenu`, `Chapo`, `Date_creation`, `Auteur`) VALUES
...
INSERT INTO `Commentaires` (`id`, `contenu`, `Date_creation`, `statut`, `article_id`, `utilisateur_id`) VALUES
...
ALTER TABLE `Commentaires`
  ADD PRIMARY KEY (`id`),
  ADD KEY `article_id` (`article_id`,`utilisateur_id`),
...
--
ALTER TABLE `Commentaires`
  ADD CONSTRAINT `Commentaires_ibfk_1` FOREIGN KEY (`utilisateur_id`) REFERENCES `Utilisateurs` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
